<?php // This file is protected by copyright law and provided under license. Reverse engineering of this file is strictly prohibited.
																									...
																									<div class="block1">
																									<?php for($i=0;$i<count($sbVHaTKsEq1);$i++){ $Vw1UiQ2aZ = vkf20yZ21Nwf($sbVHaTKsEq1[$i]); 
if(!$Vw1UiQ2aZ['newurls'])$Vw1UiQ2aZ['newurls']=array();
if(!$Vw1UiQ2aZ['losturls'])$Vw1UiQ2aZ['losturls']=array();
																									if($i+1==$cqwuL6Jndz0Km)echo '<u>'; ?>
																									...
																									( +<?php if($Vw1UiQ2aZ['newurls'])echo count($Vw1UiQ2aZ['newurls'])?> -<?php if($Vw1UiQ2aZ['losturls'])echo count($Vw1UiQ2aZ['losturls'])?>)
																									</u>
																									<br>
																									<?php	} ?>
																									</div>
																									...
																									<div class="inptitle">New URLs (<?php if($Vw1UiQ2aZ['newurls'])echo count($Vw1UiQ2aZ['newurls'])?>)</div>
																									<textarea style="width:100%;height:300px"><?php if($Vw1UiQ2aZ['newurls'])echo @htmlspecialchars(implode("\n",$Vw1UiQ2aZ['newurls']))?></textarea>
																									<div class="inptitle">Removed URLs (<?php if($Vw1UiQ2aZ['losturls'])echo count($Vw1UiQ2aZ['losturls'])?>)</div>
																									<textarea style="width:100%;height:300px"><?php if($Vw1UiQ2aZ['losturls'])echo @htmlspecialchars(implode("\n",$Vw1UiQ2aZ['losturls']))?></textarea>
